...
fn recompute_lines_updates_rendered_lines() {
    ...
    view.recompute_lines(WrapMode::Wrap, 80, &crate::state::SearchState::Inactive, false);
...
fn recompute_lines_with_different_width() {
    ...
    view.recompute_lines(WrapMode::Wrap, 40, &crate::state::SearchState::Inactive, false);
...
fn recompute_lines_respects_global_wrap_mode() {
    ...
    view.recompute_lines(WrapMode::NoWrap, 40, &crate::state::SearchState::Inactive, false);
